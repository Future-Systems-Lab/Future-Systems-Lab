...
// WellnessToken.sol — mints and distributes HNT tokens automatically when predefined health or wellness tasks complete.
...
contract WellnessToken {
    ...
    function issueReward(address _user, string memory _activity) external onlyAdmin {
        uint256 rewardAmount = 1 * 10**uint256(decimals); // 1 HNT
